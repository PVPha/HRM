...
export class RequestApiService {
  ...
  getDataRecruitment(): Observable<any[]> {
    return this.http.get<any[]>(this.getRecruitment);
    // .pipe(
    //   map((data)=> {
    //     console.log(data);
  ...
  update_staffProfile =
    'http://localhost:8080/hrm/HRM-BE/records/updateDataStaffProfile';
  get_staffProfile =
  ...
  data_contract = 'http://localhost:8080/hrm/HRM-BE/records/getDataCC';
  ...
  updateDataStaffProfile(formData: FormData): Observable<StaffProfiles> {
    return this.http.post<StaffProfiles>(this.update_staffProfile, formData);
  }
  getDataStaffProfile(): Observable<any[]> {
    return this.http.get<any[]>(this.get_staffProfile, httpOptions);
  }
  getDataCC(): Observable<any[]> {
    return this.http.get<any[]>(this.data_contract, httpOptions);
  }
