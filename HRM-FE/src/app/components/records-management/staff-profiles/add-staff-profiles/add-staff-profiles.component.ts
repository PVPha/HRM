...
export class AddStaffProfilesComponent implements OnInit {
  ...
  id_temp_contract: string = 'HD1';
  id_temp_resource: string = 'QD1';
  ngOnInit() {
    // add staff profile
    this.requestApiService.getDataStaffProfile().subscribe((value) => {
      console.log(value);
      this.id_temp_contract = 'HD' + (parseInt(value[0].ID) + 1);
      this.id_temp_resource = 'QD' + (parseInt(value[0].ID) + 1);
    });
  ...
  getDataByID(): void {
    ...
    this.requestApiService.getDataStaffProfileByID(ID).subscribe(
      (value) => {
  ...
  onSubmit(
    ...
    console.log(toJson);
    this.requestApiService.insertDataStaffProfile(formData).subscribe(
      (value) => {
        console.log(value);
        // this.staffProfiles = value;
      },
  ...
  onSubmitContract(
    ...
    console.log(toJson);
    this.requestApiService.insertDataContract(formData).subscribe(
      (value) => {
        console.log(value);
      },
      (err) => {
  ...
  onSubmitResource(
    ...
    this.requestApiService.insertDataResource(formData).subscribe(
      (value) => {
        console.log(value);
      },
      (err) => {
  ...
  @ViewChild(ViewInterviewScheduleComponent, { static: false })
  childC!: ViewInterviewScheduleComponent;
  reload() {
    this.childC.refresh();
  }
